...
public class PaxosTest extends BaseJUnitTest {
  ...
  public void test06ProgressAfterHeal() throws InterruptedException {
    ...
    System.out.printf("Running with only s1, s2, c1 in network\n");
    runState.run(runSettings);

    runSettings.maxTimeSecs(-1);
    runSettings.resetNetwork();
    System.out.printf("Reset network\n");

    runState.start(runSettings);
    assertEquals(putOk(), client1.getResult());
    System.out.printf("Check client2\n");
  ...
  public void test11ClearsMemory() throws InterruptedException {
    ...
    for (int i = 0; i < iters; i++) {
      for (int key = 0; key < items; key++) {
        System.out.printf("Putting key %d and checking\n", key);
  ...
  public void test16SinglePartition() throws InterruptedException {
    ...
    System.out.printf("Servers setup and clients started up\n");
    Thread.sleep(5000);
    assertRunInvariantsHold();
    ...
    System.out.printf("Partitioning done\n");
    Thread.sleep(1000);
    assertRunInvariantsHold();

    // Heal the partition
    runSettings.reconnect();
    System.out.printf("Partitioning healed\n");
    Thread.sleep(5000);
  ...
  public void test20basicSearch() {
    ...
    System.out.printf("Paxos can run single command check finished\n");
    ...
    assertGoalFound();
    System.out.printf("Paxos can run second command check finished\n");
    ...
    bfs(oneCommandExecuted);
    System.out.printf("Linearizability check finished\n");
